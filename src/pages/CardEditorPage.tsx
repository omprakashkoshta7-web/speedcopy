...
import { ArrowLeft, Download, Save, Palette, Type, Layout, Layers, ShoppingCart } from 'lucide-react';
                ...
                >
                  ...
                  {selectedLayout === 'vertical' && (
                    <div className="h-full flex flex-col items-center justify-center text-center">
                      <h2 className="font-bold text-3xl mb-2">{cardText.name}</h2>
                      <p className="text-lg opacity-80 mb-6">{cardText.title}</p>
                      <div className="space-y-1 text-sm opacity-90">
                        <p>{cardText.phone}</p>
                        <p>{cardText.email}</p>
                        <p>{cardText.website}</p>
                  ...
                  {selectedLayout === 'split' && (
                    <div className="h-full grid grid-cols-2 gap-8">
                      ...
                      <div className="flex flex-col justify-center space-y-1 text-sm opacity-90">
                        <p>{cardText.phone}</p>
                        <p>{cardText.email}</p>
                        <p>{cardText.website}</p>
